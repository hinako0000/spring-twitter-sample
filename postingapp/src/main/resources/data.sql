...
INSERT IGNORE INTO posts (id, user_id, title, content, created_at, updated_at) VALUES (5, 1, 'プログラミング学習5日目', '今日からはHTML/CSSの応用編！実際にWebサイトを作りながら学ぶ教材だ。基礎編で学んだことが形になっていくのはとても楽しい！この教材が終わったらオリジナルのWebサイトを作ってみたい。', '2024-01-05 00:00:00', '2024-01-05 00:00:00');